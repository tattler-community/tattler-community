...
With the auto-text feature, you only provide a ``body.html`` (or ``body.mjml``) definition,
...
need to do to use it is to provide your ``body.html`` or ``body.mjml`` content
and omit the ``body.txt`` file.
